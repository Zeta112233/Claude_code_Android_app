package com.portalagent.session;
...
public final class CodexExecSession {
    ...
    public static boolean isTransientSystemMessageForTest(String info) {
        return isTransientSystemMessage(info);
    }

    public static boolean isTransientSystemMessage(String info) {
