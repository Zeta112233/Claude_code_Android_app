...
public class AutoUbuntuManager {
    ...
    public void requestEnvironmentRepair() {
        ...
        mAutoLaunchAttempted = false;
        writeEcho(session, "[*] 环境修复：重新检查 Ubuntu、工具包和 provider 配置...");
        maybeAutoLaunchUbuntu();
    }
    ...
    static String buildEnvironmentSetupSuccessShellForTest() {
        return buildEnvironmentSetupSuccessShell();
    }
    ...
    private static String buildEnvironmentSetupSuccessShell() {
        return "echo \"[✓] PortalAgent environment setup successful.\"; ";
    }
    ...
    private String buildUbuntuCommand() {
        ...
        sb.append("if [ \"$auto_ok\" = \"1\" ]; then ")
          ...
          .append(buildEnvironmentSetupSuccessShell())
          .append("fi; ");
